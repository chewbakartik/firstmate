...
- [docs/forge-merge-watch.md](docs/forge-merge-watch.md) - maintainer verification for GitHub, GitLab, and Gitea/Forgejo merge watching and merging on arbitrary instances.
